...
namespace Convai.Scripts.Utils
{
    ...
    public class ConvaiNPCManager : MonoBehaviour
    {
        ...
        private void LateUpdate()
        {
            ...
            // Increase the Y component of the forward direction by 1
            forwardDirection.y += 0.25f;

            // Create a new ray with the modified direction
            Ray ray = new Ray(cameraTransform.position, forwardDirection);
