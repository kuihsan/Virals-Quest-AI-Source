...
namespace Zetcil
{
    ...
    public class DamageController : MonoBehaviour
    {
        ...
        public DamageController CurrentDamageController;
        public Rigidbody DamagerRigidbody;
        ...
        public void ExecuteInstantiateSFX()
        {
            if (DamageSender.usingFinishSFX)
            {
                GameObject temp = GameObject.Instantiate(DamageSender.StartSFX.TargetSFX, CurrentDamageController.transform.position, CurrentDamageController.transform.rotation);
                temp.SetActive(true);
                if (DamageSender.StartSFX.usingDestroySettings)
                {
        ...
        void Update()
        {
            ...
            {
                CurrentDamageController.gameObject.tag = DamageSender.SenderTag;
                ...
                if (DamageSender.usingTransformSetting)
                {
                    switch (DamageSender.SenderTranslateType)
                    {
                        case CTranslate.VectorUp:
                            CurrentDamageController.transform.Translate(Vector3.up * DamageSender.SenderSpeed * Time.deltaTime);
                            break;
                        case CTranslate.VectorDown:
                            CurrentDamageController.transform.Translate(Vector3.down * DamageSender.SenderSpeed * Time.deltaTime);
                            break;
                        case CTranslate.VectorForward:
                            CurrentDamageController.transform.Translate(Vector3.forward * DamageSender.SenderSpeed * Time.deltaTime);
                            break;
                        case CTranslate.VectorBack:
                            CurrentDamageController.transform.Translate(Vector3.back * DamageSender.SenderSpeed * Time.deltaTime);
                            break;
                        case CTranslate.VectorLeft:
                            CurrentDamageController.transform.Translate(Vector3.left * DamageSender.SenderSpeed * Time.deltaTime);
                            break;
                        case CTranslate.VectorRight:
                            CurrentDamageController.transform.Translate(Vector3.right * DamageSender.SenderSpeed * Time.deltaTime);
                            break;
                    }

                    CurrentDamageController.transform.Rotate(DamageSender.SenderRotation);
                }
                ...
                if (DamageSender.usingInBetweenSFX)
                {
                    DamageSender.InBetweenSFX.TargetSFX.transform.position = CurrentDamageController.transform.position;
                }
            ...
            {
                CurrentDamageController.gameObject.tag = DamageReceiver.ReceiverTag;
