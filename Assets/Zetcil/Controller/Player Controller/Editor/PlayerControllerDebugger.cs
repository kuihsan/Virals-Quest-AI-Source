...
namespace Zetcil
{
    public class PlayerControllerDebugger : EditorWindow
    {
        ...
        [MenuItem("Zetcil/Framework Debugger/Player Controller %F5", false, 6035)]
        private static void OpenWindow()
        {
            PlayerControllerDebugger window = GetWindow<PlayerControllerDebugger>();
        ...
        public bool FunctionValidation(GameObject targetObject, out int aColor, out int aObject, Vector2 aInMPos, out Vector2 aOutMPos, Vector2 aInCPos, out Vector2 aOutCPos, Vector2 aInVPos, out Vector2 aOutVPos)
        {
            ...
            //-- Controller
            else if (targetObject.GetComponent<DamageController>())
            {
                if (targetObject.GetComponent<DamageController>().isEnabled)
                {
                    aColor = ORANGE;
                    if (targetObject.GetComponent<DamageController>().CurrentDamageController != null &&
                        targetObject.GetComponent<DamageController>().DamagerRigidbody != null)
                    {
                        aColor = GREEN;
                    }
                }
            ...
            else if (targetObject.GetComponent<PositionController>())
            {
                if (targetObject.GetComponent<PositionController>().isEnabled)
                {
                    aColor = ORANGE;
                    if (targetObject.GetComponent<PositionController>().TargetHealth != null &&
                        targetObject.GetComponent<PositionController>().TargetController != null &&
                        targetObject.GetComponent<AnimationController>().isEnabled &&
                        targetObject.GetComponent<AnimationController>().TargetHealth != null &&
                        targetObject.GetComponent<AnimationController>().TargetController != null &&
                        targetObject.GetComponent<AnimationController>().TargetAnimator != null
                        )
                    {
                        aColor = GREEN;
                    }
            ...
            else if (targetObject.GetComponent<SpritePositionController>())
            {
                if (targetObject.GetComponent<SpritePositionController>().isEnabled)
                {
                    aColor = ORANGE;
                    if (targetObject.GetComponent<SpritePositionController>().TargetHealth != null &&
                        targetObject.GetComponent<SpritePositionController>().TargetController != null &&
                        targetObject.GetComponent<SpriteAnimationController>().isEnabled &&
                        targetObject.GetComponent<SpriteAnimationController>().TargetHealth != null &&
                        targetObject.GetComponent<SpriteAnimationController>().TargetController != null &&
                        targetObject.GetComponent<SpriteAnimationController>().TargetAnimator != null)
                    {
                        aColor = GREEN;
                    }
                }
