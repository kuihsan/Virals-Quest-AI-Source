...
namespace Zetcil
{
    [CustomEditor(typeof(SpriteShootingController)), CanEditMultipleObjects]
    public class SpriteShootingControllerEditor : Editor
    {
        ...
        void OnEnable()
        {
            ...
            AfterShooting = serializedObject.FindProperty("AfterShooting");
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (check)
            {
                ...
                {
                    EditorGUILayout.PropertyField(AfterShooting);
