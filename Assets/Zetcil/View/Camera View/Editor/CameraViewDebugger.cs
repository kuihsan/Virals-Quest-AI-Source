...
namespace Zetcil
{
    public class CameraViewDebugger : EditorWindow
    {
        ...
        [MenuItem("Zetcil/Framework Debugger/Camera View %F3", false, 6033)]
        private static void OpenWindow()
        {
            CameraViewDebugger window = GetWindow<CameraViewDebugger>();
        ...
        public bool FunctionValidation(GameObject targetObject, out int aColor, out int aObject, Vector2 aInMPos, out Vector2 aOutMPos, Vector2 aInCPos, out Vector2 aOutCPos, Vector2 aInVPos, out Vector2 aOutVPos)
        {
            ...
            //-- VIEW Group
            else if (targetObject.GetComponent<CameraADV>())
            {
                if (targetObject.GetComponent<CameraADV>().isEnabled)
                {
                    aColor = ORANGE;
                    if (targetObject.GetComponent<CameraADV>().TargetCamera != null &&
                        targetObject.GetComponent<CameraADV>().TargetController != null)
                    {
                        aColor = GREEN;
                    }
                }
                else { aColor = RED; }
                aInVPos.y += yOffset; result = true;
                aObject = VIEW;
            }
            else if (targetObject.GetComponent<CameraAVI>())
            {
                if (targetObject.GetComponent<CameraAVI>().isEnabled)
                {
                    aColor = ORANGE;
                    if (targetObject.GetComponent<CameraAVI>().TargetCamera != null)
                    {
                        aColor = GREEN;
                    }
                }
            ...
            else if (targetObject.GetComponent<CameraCMC>())
            {
                if (targetObject.GetComponent<CameraCMC>().isEnabled)
                {
                    aColor = ORANGE;
                    if (targetObject.GetComponent<CameraCMC>().TargetCamera != null)
                    {
                        aColor = GREEN;
                    }
                }
            ...
            else if (targetObject.GetComponent<CameraCUT>())
            {
                if (targetObject.GetComponent<CameraCUT>().isEnabled)
                {
                    aColor = ORANGE;
                    if (targetObject.GetComponent<CameraCUT>().TargetCamera != null)
                    {
                        aColor = GREEN;
                    }
                }
            ...
            else if (targetObject.GetComponent<CameraFPS>())
            {
                if (targetObject.GetComponent<CameraFPS>().isEnabled)
                {
                    aColor = ORANGE;
                    if (targetObject.GetComponent<CameraFPS>().TargetCamera != null &&
                        targetObject.GetComponent<CameraFPS>().TargetController != null)
                    {
                        aColor = GREEN;
                    }
                }
            ...
            else if (targetObject.GetComponent<CameraGIZ>())
            {
                if (targetObject.GetComponent<CameraGIZ>().isEnabled)
                {
                    aColor = ORANGE;
                    if (targetObject.GetComponent<CameraGIZ>().TargetCamera != null)
                    {
                        aColor = GREEN;
                    }
                }
            ...
            else if (targetObject.GetComponent<CameraHIT>())
            {
                if (targetObject.GetComponent<CameraHIT>().isEnabled)
                {
                    aColor = ORANGE;
                    if (targetObject.GetComponent<CameraHIT>().TargetCamera != null)
                    {
                        aColor = GREEN;
                    }
                }
            ...
            else if (targetObject.GetComponent<CameraMAP>())
            {
                if (targetObject.GetComponent<CameraMAP>().isEnabled)
                {
                    aColor = ORANGE;
                    if (targetObject.GetComponent<CameraMAP>().TargetCamera != null &&
                        targetObject.GetComponent<CameraMAP>().TargetController != null)
                    {
                        aColor = GREEN;
                    }
                }
            ...
            else if (targetObject.GetComponent<CameraMMO>())
            {
                if (targetObject.GetComponent<CameraMMO>().isEnabled)
                {
                    aColor = ORANGE;
                    if (targetObject.GetComponent<CameraMMO>().TargetCamera != null &&
                        targetObject.GetComponent<CameraMMO>().TargetController != null)
                    {
                        aColor = GREEN;
                    }
                }
            ...
            else if (targetObject.GetComponent<CameraRAY>())
            {
                if (targetObject.GetComponent<CameraRAY>().isEnabled)
                {
                    aColor = ORANGE;
                    if (targetObject.GetComponent<CameraRAY>().TargetCamera != null &&
                        targetObject.GetComponent<CameraRAY>().SelectedObject != null)
                    {
                        aColor = GREEN;
                    }
                }
            ...
            else if (targetObject.GetComponent<CameraRPG>())
            {
                if (targetObject.GetComponent<CameraRPG>().isEnabled)
                {
                    aColor = ORANGE;
                    if (targetObject.GetComponent<CameraRPG>().TargetCamera != null &&
                        targetObject.GetComponent<CameraRPG>().TargetController != null)
                    {
                        aColor = GREEN;
                    }
                }
            ...
            else if (targetObject.GetComponent<CameraRTS>())
            {
                if (targetObject.GetComponent<CameraRTS>().isEnabled)
                {
                    aColor = ORANGE;
                    if (targetObject.GetComponent<CameraRTS>().TargetCamera != null)
                    {
                        aColor = GREEN;
                    }
                }
            ...
            else if (targetObject.GetComponent<CameraSSP>())
            {
                if (targetObject.GetComponent<CameraSSP>().isEnabled)
                {
                    aColor = ORANGE;
                    if (targetObject.GetComponent<CameraSSP>().TargetCamera != null &&
                        targetObject.GetComponent<CameraSSP>().TargetController != null)
                    {
                        aColor = GREEN;
                    }
                }
            ...
            else if (targetObject.GetComponent<CameraTPV>())
            {
                if (targetObject.GetComponent<CameraTPV>().isEnabled)
                {
                    aColor = ORANGE;
                    if (targetObject.GetComponent<CameraTPV>().TargetCamera != null &&
                        targetObject.GetComponent<CameraTPV>().TargetController != null)
                    {
                        aColor = GREEN;
                    }
                }
            ...
            else if (targetObject.GetComponent<CameraUFO>())
            {
                if (targetObject.GetComponent<CameraUFO>().isEnabled)
                {
                    aColor = ORANGE;
                    if (targetObject.GetComponent<CameraUFO>().TargetCamera != null)
                    {
                        aColor = GREEN;
                    }
                }
