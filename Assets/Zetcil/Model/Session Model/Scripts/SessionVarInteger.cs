...
namespace Zetcil
{
    public class SessionVarInteger : MonoBehaviour
    {
        [Space(10)]
        ...
        public VarInteger SessionValue;
        ...
        public void SetSessionValue(VarInteger aValue)
        {
            SessionValue.CurrentValue = aValue.CurrentValue;
        }

        public void SetSessionValue(int aValue)
        {
        ...
        public void LoadSession(string aSessionKey)
        {
            ...
            if (File.Exists(FullPathFile))
            {
                ...
                SessionValue.CurrentValue = int.Parse(xmlnodelist.Item(0).InnerText.Trim());
            }
        }
