...
namespace Zetcil
{
    public class SessionVarBoolean : MonoBehaviour
    {
        [Space(10)]
        ...
        public VarBoolean SessionValue;
        ...
        public void SetSessionValue(VarBoolean aValue)
        {
            SessionValue.CurrentValue = aValue.CurrentValue;
        }

        public void SetSessionValue(bool aValue)
        {
            SessionValue.CurrentValue = aValue;
        }

        public void SetSessionValue(Toggle aValue)
        {
            SessionValue.CurrentValue = aValue.isOn;
        }
