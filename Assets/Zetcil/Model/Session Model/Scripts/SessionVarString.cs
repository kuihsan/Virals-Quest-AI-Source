...
namespace Zetcil
{
    public class SessionVarString : MonoBehaviour
    {
        [Space(10)]
        ...
        public void SetSessionValue(string aValue)
        {
            SessionValue.CurrentValue = aValue;
        }

        public void SetSessionValue(InputField aValue)
        {
            SessionValue.CurrentValue = aValue.text;
        }

        public void SetSessionValue(Text aValue)
        {
            SessionValue.CurrentValue = aValue.text;
        }
        ...
        public void SaveSession(string aSessionName)
        {
            ...
            string singleValue = SessionConfig.SetXMLValueSingle("SessionValue", SessionValue.CurrentValue);
        ...
        public void LoadSession(string aSessionKey)
        {
            ...
            if (File.Exists(FullPathFile))
            {
                ...
                SessionValue.CurrentValue =  xmlnodelist.Item(0).InnerText.Trim();
            }
        }
