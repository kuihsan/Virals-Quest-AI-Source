...
public class PoserModelEditor : EditorWindow
{
    #region Filed

    public string outputDirectory = null;

    public string outputFileName = PoserModel.DefaultOutputFileName;
    ...
    [MenuItem("Zetcil/Tools/Capture Image Function", false, 50)]
    static void Init()
    {
        EditorWindow.GetWindow<PoserModelEditor>("Poser Model");
    }
    ...
    protected void OnGUI()
    {
        ...
        EditorGUILayout.LabelField("Drag Active Camera here!", marginStyle);
    ...
    protected PoserModel.CaptureResult Capture()
    {
        ...
        PoserModel.CaptureResult result
        = PoserModel.Capture(camera,
                                   imageWidth,
                                   imageHeight,
                                   this.clearBack,
    ...
    protected virtual void HookAfterImageCaptured(PoserModel.CaptureResult result)
    {
