...
namespace Zetcil
{
    [CustomEditor(typeof(LayoutTheme)), CanEditMultipleObjects]
    public class LayoutThemeEditor : Editor
    {
...

        {
            ...
            PresetDefault = serializedObject.FindProperty("PresetDefault");
            PresetVermilion = serializedObject.FindProperty("PresetVermilion");
            PresetEmerald = serializedObject.FindProperty("PresetEmerald");
            PresetAzure = serializedObject.FindProperty("PresetAzure");
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (isEnabled.boolValue)
            {
                ...
                EditorGUILayout.PropertyField(PresetDefault, true);
                EditorGUILayout.PropertyField(PresetVermilion, true);
                EditorGUILayout.PropertyField(PresetEmerald, true);
                EditorGUILayout.PropertyField(PresetAzure, true);
                ...
                {
                    HeaderTransparency.floatValue = 0.7f;
                    FooterTransparency.floatValue = 0.7f;
                    BackgroundTransparency.floatValue = 0.7f;
                    PanelTransparency.floatValue = 0.7f;
                    IconTransparency.floatValue = 0.7f;
                    PrimaryButtonTransparency.floatValue = 0.7f;
                    SecondaryButtonTransparency.floatValue = 0.7f;
