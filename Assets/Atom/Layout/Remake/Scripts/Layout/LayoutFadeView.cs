...
[CustomEditor(typeof(LayoutFadeView))]
[ExecuteInEditMode]
public class LayoutFadeViewEditor : Editor
{
    //Fetches or creates the CanvasGroup on enable
    private void OnEnable()
    {
        LayoutFadeView Controller = (LayoutFadeView)target;
...
public class LayoutFadeView : MonoBehaviour
{
    //Private Variables
